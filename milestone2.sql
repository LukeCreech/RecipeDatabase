...
INSERT INTO Instruction (recipeID, stepNumber, step)
VALUES (4, 1, "Add the oyster sauce, brown sugar, soy sauce and sesame oil to a bowl and stir until combined."),
(4, 2, "Bring a large pot of water to a boil and cook the noodles according to the package directions (boil for 7-10 minutes). Drain the cooked noodles in a colander, then set aside."),
(4, 3, "While the pasta cooks, mince the garlic and slice the green onions. Melt the butter in a large skillet over medium-low heat. Once the butter is melted and bubbly, add the garlic and onions (save a few for garnish) and sauté until they are soft and fragrant (1-2 minutes)."),
(4, 4, "Remove the skillet from the heat. Add the drained pasta and oyster sauce mixture to the skillet, and stir well to coat the pasta. If your pasta is stiff or sticky making it hard to stir, sprinkle a small amount of hot water over the pasta to loosen it up. Garnish the pasta with any reserved sliced green onions, then serve.");

INSERT INTO Ingredient (recipeID, ingredientName, cost)
VALUES (4, "8 oz angel hair pasta", 0.54),
(4, "4 cloves garlic", 0.24),
(4, "1/2 bunch green onions", 035),
(4, "4 Tbsp butter ", 0.50),
(4, "2 tsp soy sauce", 0.20),
(4, "2 Tbsp brown sugar", 0.05),
(4, "1 tsp sesame oil ", 0.40),
(4, "2 Tbsp oyster sauce", 0.26);
...
INSERT INTO Comment (username, recipeID, commentText)
VALUES ("lukecreech", 4, "Great recipe that I added to my rotation, I had never tried this before.");
...
(8, 6, "Add the cream cheese to the skillet in chunks, then stir until it has melted into the sauce. Top the pasta with sliced green onions and serve.");
...
(16, "1.5 tsp baking powder", 0.03),
(16, "1/2 tsp salt", 0.03),
(16, "3/4 cup warm milk", 0.02),
(16, "2 Tbsp melted butter", 0.20),
(16, "1 large egg", 0.21),
(16, "2 Tbsp sugar", 0.02),
(16, "1/2 tsp vanilla extract", 0.14),
(16, "4 tsp cooking oil", 0.05);
...
(17, "1 tsp salt", 0.05),
(17, "1 Tbsp sugar", 0.02),
(17, "4 tsp baking powder", 0.16),
(17, "1 pint heavy whipping cream", 3.65);
...
(18, "1/3 cup olive oil", 0.78),
(18, "6 cloves garlic", 0.48),
(18, "1/4 tsp salt", 0.02),
(18, "Freshly cracked pepper", 0.05),
(18, "2 lbs split chicken breasts", 4.77);
...
(19, "1 pint heavy whipping cream, very cold", 3.29),
(19, "3 egg whites, room temperature", 1.25),
(19, "1/2 cup powdered sugar or sugar substitute", 0.13);
...
(20, "3 Tbsp corn starch", 0.09),
(20, "3 cups whole milk", 0.73),
(20, "3 large egg yolk", 0.60),
(20, "1.5 tsp vanilla extract", 0.87),
(20, "3 Tbsp salted butter", 0.38);
